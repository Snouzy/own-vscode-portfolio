        ...
        <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
          ...
          {mutation.isSuccess && (
            <div className={styles.success}>
              <p>Parfait ! Ton email a été enregistré.</p>
              <p>
                <strong>Accède directement à tes prompts ici :</strong><br/>
                <a 
                  href="https://docs.google.com/document/d/1bV5DRocQv7CV6NafOx1nhQX49zzVkWkG/edit?usp=sharing&ouid=101098265552681122867&rtpof=true&sd=true"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={styles.link}
                >
                  📄 Ma liste de prompts gratuits
                </a>
              </p>
            </div>
          )}
